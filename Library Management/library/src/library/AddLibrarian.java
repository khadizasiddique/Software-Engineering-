...
public class AddLibrarian extends JFrame  implements ActionListener
{
     ...
     JButton bt1,bt2;
     JPanel p1,p2,p3;
     JTextField tf1,tf2,tf3,tf4,tf,tf5,tf6;
     JPasswordField pf1;
     Font f,f1;
    AddLibrarian()
    {
       ...
       p1=new JPanel();
       p1.setLayout(new GridLayout(1,1,0,01));
       p1.add(l1);
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==bt1)
        {
             if(name.equals("")||pass.equals("")||email.equals("")||contact.equals("")||add.equals("")||city.equals(""))
            {
